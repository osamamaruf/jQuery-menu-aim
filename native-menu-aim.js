...
_menuAim = _menuAim || (function () {
    ...
    function init(m, opts) {
        ...
        var activationDelay = function () {
            if (!activeRow || !closest(activeRow, options.submenuSelector)) {
                // If there is no other submenu row already active, then
                // go ahead and activate immediately.                
                return 0;
            }
            var offset = getElementOffset(menu),
                upperLeft = {
                    x: offset.left,
        ...
        //child events configuration        
        var _submenu = menu.querySelectorAll(options.rowSelector);        
        for (li = 0; li < _submenu.length; ++li) {
            _submenu[li].onmouseenter = mouseenterRow;
            _submenu[li].onmouseleave = mouseleaveRow;
            _submenu[li].onclick = clickRow;
        }
